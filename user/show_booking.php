                ...
                <table id="my_table_1" data-toggle="table" data-sort-stable="true">
                    ...
                    <tbody>
                        <?php
                            ...
                            {
                                $search = $_POST['search'];
                                $sql="SELECT * FROM booking WHERE username='$username' AND (train_id='$search' OR ticket_id='$search' OR src='$search' OR des='$search');";
                                ...
                                if($num!=0)
                                {
                                    while($row=mysqli_fetch_assoc($res))
                                    {
                                        ...
                                        echo '<tr>
                                            ...
                                            <td>
                                                <div class="d-inline">
                                                <a href="print.php?ticket_id='.$row['ticket_id'].'&train_id='.$row['train_id'].'" target="_blank">
                                                <button name="print" class="btn btn-primary btn-sm">
