<?php
    ...
    {
        header("location : ../index/login_user.php");
        exit;
    }
?>
                ...
                echo '<div class="col-md-4 px-0 my-4 cards">
                    ...
                    border: 1px solid rgba( 255, 255, 255, 0.18 );">
                        <div class="card-body">
                            ...
                            <p class="card-text text-left" style="margin-bottom:0.5rem;">'.$row['src'].' -> '.$row['des'].'</p>
                            <span>Ticket Price - &#8377 '.$row['fare'].'</span>
                            <br><div class="px-2" style="text-align:right;">
                            <a class="btn btn-primary" href="bk_tkt.php?train_id='.$row['train_id'].'" class="card-link">Book Ticket</a>
                            </div>
                        </div>
                    </div>
                </div>';
