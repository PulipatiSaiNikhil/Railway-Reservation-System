    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="../user/welcome_user.php">Home</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="../user/check_train.php">Check Trains</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="../user/bk_tkt.php">Book Ticket</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="../user/show_booking.php">Show Bookings</a>
                </li>
            </ul>
        </div>
