            ...
            <ul class="list-group">
                ...
                <table id="my_table_1" data-toggle="table" data-sort-stable="true">
                    ...
                    <?php
                            ...
                            {
                                $search = $_POST['search'];
                                $sql="SELECT * FROM users WHERE role='0' AND (username='$search' OR email='$search');";
                                ...
                                if($num!=0)
                                {
                                    while($row=mysqli_fetch_assoc($res))
                                    {
                                        ...
                                        echo '<tr>
                                            ...
                                            <td>
                                                <div class="d-inline">
                                                    <a href="show_booking.php?username='.$row['username'].'">
                                                        <button name="view" class="mx-2 btn btn-primary btn-sm">
                                                        <i class="fa fa-eye"></i> Bookings</button>
                                                    </a>
                                                </div>
                                                <div class="d-inline">
                                                    <a href="functions/dlt_user.php?username='.$row['username'].'">
